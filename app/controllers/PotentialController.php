...
class PotentialController extends AdminController {
    ...
    public function makeActions($data)
    {
        ...
        $edit = '<a href="'.URL::to('potential/edit/'.$data['_id']).'"><i class="icon-edit"></i>Update</a>';
